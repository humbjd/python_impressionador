...
if qtde_vendida > meta:
    print('Batemos a meta de vendas de Iphone, vendemos mais de {} unidades'.format(qtde_vendida))
else:
    print('A meta não foi batida, vendemos somente {}'.format(qtde_vendida))
